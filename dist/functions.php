...
/**
 * Add uploadable file types.
 *
 * @param Object $mimes Mime types object.
 */
function sha_allow_upload( $mimes ) {
	$mimes['qwl'] = 'application/octet-stream';
	$mimes['ptp'] = 'application/octet-stream';
	return $mimes;
}
add_filter( 'upload_mimes', 'sha_allow_upload' );
